...
class PyDocXHTMLExporter(PyDocXExporter):
    ...
    def modify_text_encoding_v1(self, paragraph):
        if isinstance(paragraph, wordprocessing.Paragraph):
            ascii = None
            for style in paragraph.get_style_chain_stack():
                if style.run_properties is not None:
                    if style.run_properties.r_fonts is not None:
    ...
    def export_paragraph(self, paragraph):
        self.modify_text_encoding_v1(paragraph)
